...
@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('process_import_student') }}" method="post" class="mx-auto" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label">Số Sinh Viên/Lớp</label>
                    <div class="col-sm-8">
                        <input type="text" name="student1class" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-8">
                        <button type="submit" class="btn btn-primary">Nhập Sinh Viên Và Chia Lớp</button>
                    </div>
                </div>
            </form>
        </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("select[name='major']").append(
                                "<option selected hidden disable>---Chọn Ngành---</option>"
                            );
