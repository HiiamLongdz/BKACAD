...
@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('process_create_subject') }}" method="post" class="mx-auto">
                @csrf
                ...
                <div class="form-group row col-8">
                    <label for="" class="col-sm-3 col-form-label">Tên Môn</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row col-8">
                    <label for="" class="col-sm-3 col-form-label">Loại Kiểm Tra</label>
                    <div class="col-sm-8">
